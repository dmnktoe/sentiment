        ...
        <div>
          ...
          {articles.data.map((article) => (
            <div key={article.id}>
              ...
              <h2 className="mb-3 text-xs">{article.publishedAt}</h2>
              <div className="flex gap-2 align-top justify-items-start">
                <Image
                  width="100"
                  height="100"
                  src={'https://cms.project-sentiment.org' + article.image.url}
        ...
        <div>
          ...
          {projects.data.map((project) => (
            <div key={project.id}>
              ...
              <h2 className="mb-3 text-xs">{project.publishedAt}</h2>
              <div className="flex gap-2 align-top justify-items-start">
                <Image
                  width="100"
                  height="100"
                  src={'https://cms.project-sentiment.org' + project.image.url}
